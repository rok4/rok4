...
+ { register huff_entropy_ptr entropy = ( huff_entropy_ptr ) cinfo->entropy;
    ...
    +   do entropy->saved.last_dc_val[ci] = 0;
...
fake_SOS_marker ( j_decompress_ptr cinfo ) {
    return JPEG_REACHED_SOS;
}

/*ARGSUSED*/ METHODDEF ( int )
suspend ( j_decompress_ptr cinfo ) {
    ...
    */
    ...
    L3:
        ...
        default              :
            ...
            */
        case JPEG_SUSPENDED  :
            if ( sp->cinfo.d.input_scan_number
