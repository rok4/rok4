...
bit_size ( png_const_structp pp, png_byte colour_type, png_byte bit_depth ) {
    switch ( colour_type ) {
    default:
        png_error ( pp, "invalid color type" );
...
init_validate_info ( validate_info *vi, gamma_display *dp, png_const_structp pp,
    ...
    if ( ( dp->this.colour_type & PNG_COLOR_MASK_ALPHA ) != 0 ||
        ...
        if ( vi->do_background != 0 ) {
            ...
            r = dp->background_color.red;
            r /= outmax;
            g = dp->background_color.green;
            g /= outmax;
            b = dp->background_color.blue;
            b /= outmax;
...
png_pass_col_shift ( int pass ) {
    ...
    switch ( inc ) {
    case 1:
        return 0; /* pass 7 has all the columns */
    case 2:
        return 1;
    case 4:
        return 2;
...
static PNG_CONST color_encoding test_encodings[] = {
    ...
    /*gamma:*/ {
        1/1.6 /*approximate: uses 1.8 power law compared to sRGB 2.4*/,
