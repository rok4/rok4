...
IF(HAVE_KAKADU)
    if(NOT TARGET kakadu)
        find_package(KAKADU)
        if(KAKADU_FOUND)
          add_library(kakadu SHARED IMPORTED)
          set_property(TARGET kakadu PROPERTY IMPORTED_LOCATION ${KAKADU_LIBRARY})
        else(KAKADU_FOUND)
          message(FATAL_ERROR "Cannot find extern library Kakdu")
        endif(KAKADU_FOUND)
    endif(NOT TARGET kakadu)
ELSE(HAVE_KAKADU)
