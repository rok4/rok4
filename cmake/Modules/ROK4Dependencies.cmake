...
IF(HAVE_KAKADU)
message(STATUS "I want kakadu")
    if(NOT TARGET jpeg2000)
        find_package(KAKADU)
        if(KAKADU_FOUND)
message(STATUS "I found kakadu")
...
message(STATUS "JPEG2000_INCLUDE_DIR : ${JPEG2000_INCLUDE_DIR}")
message(STATUS "KAKADU_LIBRARY_1 : ${KAKADU_LIBRARY_1}")
message(STATUS "KAKADU_LIBRARY_2 : ${KAKADU_LIBRARY_2}")
        else(KAKADU_FOUND)
            message(STATUS "JPEG2000_INCLUDE_DIR : ${JPEG2000_INCLUDE_DIR}")
message(STATUS "KAKADU_LIBRARY_1 : ${KAKADU_LIBRARY_1}")
message(STATUS "KAKADU_LIBRARY_2 : ${KAKADU_LIBRARY_2}")
