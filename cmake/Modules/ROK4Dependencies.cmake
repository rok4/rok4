...
if(LOGGER_FOUND)
  ...
  if(BUILD_DEPENDENCIES)
    ...
    INSTALL(FILES ${ROK4LIBSDIR}/liblogger/README ${ROK4LIBSDIR}/liblogger/LICENCE DESTINATION doc/logger)
  endif(BUILD_DEPENDENCIES)
endif(LOGGER_FOUND)
...
ELSE(KDU_USE)
    ...
    if(OPENJPEG_FOUND)
      ...
      if(BUILD_DEPENDENCIES)
        ...
        INSTALL(FILES ${ROK4LIBSDIR}/libopenjpeg/AUTHORS ${ROK4LIBSDIR}/libopenjpeg/CHANGES ${ROK4LIBSDIR}/libopenjpeg/LICENSE ${ROK4LIBSDIR}/libopenjpeg/NEWS ${ROK4LIBSDIR}/libopenjpeg/README ${ROK4LIBSDIR}/libopenjpeg/THANKS DESTINATION doc/openjpeg)
      endif(BUILD_DEPENDENCIES)
...
if(IMAGE_FOUND)
  ...
  if(BUILD_DEPENDENCIES)
    ...
    INSTALL(FILES ${ROK4LIBSDIR}/libimage/LICENCE ${ROK4LIBSDIR}/libimage/README DESTINATION doc/libimage)
  endif(BUILD_DEPENDENCIES)
endif(IMAGE_FOUND)
