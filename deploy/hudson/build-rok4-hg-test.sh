...
rm -f $ROK4BASE/builds/rok4-rev${MERCURIAL_REVISION}.tgz
...
tar -cvzf rok4-rev${MERCURIAL_REVISION}.tgz bin/rok4 docs
mv rok4-rev${MERCURIAL_REVISION}.tgz $ROK4BASE/builds/
