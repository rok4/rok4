...
RUN apt remove -y build-essential cmake libfcgi-dev libtinyxml-dev libopenjp2-7-dev libboost-log-dev libboost-filesystem-dev libboost-system-dev zlib1g-dev libtiff5-dev libpng-dev libcurl4-openssl-dev libssl-dev libturbojpeg0-dev libjpeg-dev libc6-dev librados-dev
